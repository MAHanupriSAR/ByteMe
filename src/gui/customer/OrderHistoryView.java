...
public class OrderHistoryView extends JPanel {
    ...
    public OrderHistoryView(Map<Order.OrderStatus,ArrayList<Order>> pastOrders) {
    ...
    private void showOrders(Map<Order.OrderStatus,ArrayList<Order>> pastOrders){
        JPanel ordersPanel = new JPanel();
        ordersPanel.setLayout(new BoxLayout(ordersPanel, BoxLayout.Y_AXIS));

        for(Map.Entry<Order.OrderStatus,ArrayList<Order>> entry : pastOrders.entrySet()){
            ...
            for (Order order : orders) {
                String orderDetailsText = order.toString();
    ...
    private String getOrderDetails(Order order) {
        ...
        for (Map.Entry<MenuItem, Integer> itemEntry : order.getItems().entrySet()) {
            ...
            details.append(" (x").append(itemEntry.getValue());
            details.append(")\n");
        }
